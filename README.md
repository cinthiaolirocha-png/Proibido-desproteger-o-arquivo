...
InfoTab:AddParagraph({ "Owner / Developer:", "Skyline" })
InfoTab:AddParagraph({ "Collaborations:", "Skyline,Gusta" })
InfoTab:AddParagraph({ "You are using:", "Skyline Hub Brookhaven " })
...
InfoTab:AddDiscordInvite({
    Name = "veloz Hub",
    Description = "https://discord.gg/Kp5BPGFb8",
    Logo = "rbxassetid://124557134667231",
    Invite = "https://discord.gg/gvmhXpGtkV",
})
...
Tab16:AddButton({
    ...
    Callback = function()
       loadstring(game:HttpGet("https://pastefy.app/r3sgYiTO/raw"))()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Painel Admin",
